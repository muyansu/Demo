...
let getWeather = `https://www.yiketianqi.com/free/day?appid=72693185&appsecret=DQb7Pxn9&unescape=1&cityid=101060101`//获取指定地区天气（写你自己的）
	...
	Promise.all([AccessToken,Weather,Statements]).then((res)=>{
		...
		let data = {
			...
			data:{
                ...
                data2:{//多少天
					value:String(getTargetTime('2022-10-06')),//设置在一起的日子，格式别变
					color:coloring()
				},
                data3:{//多少天
					value:String(getTargetTime('2022-10-25')),//设置在一起的日子，格式别变
					color:coloring()
				},
				remake:{//备注
					value:'比昨天更爱你的一天',
